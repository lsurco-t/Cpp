...
int main(void){
	...
	try {
		Bureaucrat b2("Alice", 2);
		Form f2("Traininship", 1, 4);

		std::cout << "\033[33mBefore promotion: \033[0m" <<  b2 << std::endl;
		b2.signForm(f2);
		std::cout << "\033[33mForm signed: \033[0m" << f2.getIsSigned() << std::endl; 
		std::cout << "\033[33mFinal Bureaucrat: \033[0m" << b2 << std::endl;
